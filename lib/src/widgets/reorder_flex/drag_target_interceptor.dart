...
class OverlappingDragTargetInterceptor extends DragTargetInterceptor {
  ...
  final AATexBoardState columnsState;
  ...
  bool onWillAccept({
    ...
    if (dragTargetId == dragTargetData.reorderFlexId) {
      ...
      ///
      _delayOperation?.cancel();
      _delayOperation = Timer(const Duration(milliseconds: 400), () {
        ...
        if (index != -1) {
          ...
          columnsState.reorderFlexActionMap[dragTargetId]?.resetDragTargetIndex(index);
        }
      });
    }
